"""Trained local-analyzer scorer artifact training and runtime scoring."""
...
from app.analyzer.calibrate import decide_investigation, load_calibration_corpus
from app.analyzer.contracts import LocalAnalyzerDecision, RetrievalHit
from app.analyzer.fast_scorer import FastScorer
from app.analyzer.temporal_features import TEMPORAL_FEATURE_SET_VERSION, TemporalFeatureVector, extract_temporal_features
...
def _iter_calibration_training_rows(
    *,
    ...
    for case in load_calibration_corpus(calibration_corpus_path):
        ...
        evidence = json.loads((repo_root / case["evidence_fixture"]).read_text(encoding="utf-8"))
