...
CURRENT_STATUS = REPO_ROOT / "docs" / "plan" / "warning-agent-production-readiness-foundation-2026-04-20_STATUS.md"
CURRENT_WORKSET = REPO_ROOT / "docs" / "plan" / "warning-agent-production-readiness-foundation-2026-04-20_WORKSET.md"
...
def test_pyproject_metadata_matches_package() -> None:
    ...
    assert metadata.phase == "production-readiness-foundation"
